...
console.log(a.endsWith("o",6));    //true   => Elzero
```

**Note**:
 - substr(Start , **Characters To Extract** (*Not end index*) ).
 - endsWith(Value , Length *(Not index)* )
